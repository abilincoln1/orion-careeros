...
| [0006](../docs/adr/0006-document-intelligence-engine.md) | Document Intelligence Engine as a Platform Kernel Capability | Accepted | 2026-08-05 | Records the Chief Architect's redirect of Sprint 3 Stage 1 from a CareerOS-local "CV Intelligence" CV parser to a reusable Platform Kernel "Document Intelligence Engine," extensible to document types beyond CVs and to future ORION products beyond CareerOS. Explicitly reconciles this kernel placement against ADR 0005's opposite conclusion for File Storage, on the grounds that cross-product reuse is this capability's stated purpose rather than a possible future benefit. |
