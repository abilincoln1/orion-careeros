...
| ID | Risk | Likelihood | Impact | Mitigation | Owner | Status |
|---|---|---|---|---|---|---|
| RB-01 | Scope creep: an agent (or contributor) implements authorized-sounding business logic (Career DNA, Job Intelligence, AI) ahead of explicit authorization. | Low (explicitly guarded against in this directive and in `governance/SPRINT_APPROVAL_PROCESS.md`) | High (violates Human Approval / governance discipline that is core to the product's credibility) | **Re-opened and re-closed during Sprint 1.6.** Originally marked Mitigated on the incorrect claim that "this Sprint 1 Closure work deliberately implements none" -- false as of the same commit it was written in; the Career DNA schema was already present. Sprint 1.5's Repository Reconciliation Report found this and Sprint 1.6's Candidate Acceptance Review confirmed the implementation itself was deliberate, spec-driven, and gated by a real independent architecture review (`docs/SPRINT-2-ARCHITECTURE-REVIEW.md`) -- the actual gap was that governance/planning documents were never reconciled against the completed work, not that the work bypassed review entirely. Closed by: retroactive ADR 0004, the Sprint 1.6 test-completion pass, and this corrected register entry. | Chief Architect | Mitigated (corrected) |
